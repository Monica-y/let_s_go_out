...
$(document).ready(function () {
    ...
    var pinglun = document.getElementById("jdpinglun");
    ...
    $.ajax({
        ...
        success: function (data, textStatus) {
            ...
            if(data.state == 50000){
                data.sights=JSON.parse( data.sights)
                document.getElementById("lujingjingdianming").innerHTML=data.sights.sightName;
                document.getElementById("jingdianming").innerHTML=data.sights.sightName;
                document.getElementById("jd_detail_pho").src=data.sights.sightPho;
                document.getElementById("jdmiaoshu").innerHTML=data.sights.sightInfo;
                document.getElementById("jdaddress").innerHTML=data.sights.sightAddress;
                for(var i=0;i<n;i++){
...
function subsightpl(){
    ...
    var userreview = document.getElementById("sightuserreview").value;
    $.ajax({
        ...
        success: function (data,textStatus){
            if (data.state == 50000) {
                alert("发表成功");
                window.location.href = "sightsDetail.html?type=sights&id="+id;
